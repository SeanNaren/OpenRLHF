...
def remote_rm_fn(api_url, queries, prompts, input_dict, score_key="rewards"):
    ...
    """
    scores = request_api_wrapper(api_url, {"query": queries, "prompts": prompts, "input_dict": input_dict}, score_key)
    return torch.tensor(scores)


@ray.remote
def remote_rm_fn_ray(api_url, queries, prompts, input_dict, score_key="rewards"):
    return remote_rm_fn(api_url, queries, prompts, input_dict, score_key)
